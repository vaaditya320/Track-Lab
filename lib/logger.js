...
class CloudWatchLogger {
  ...
  async logAdminAction(message, type = LogType.OTHER, metadata = {}) {
    try {
...
// Export the logging function with type
export const logAdminAction = (message, type = LogType.OTHER, metadata = {}) => 
  cloudWatchLogger.logAdminAction(message, type, metadata); 